        ...
        <div className="bg-warm-gray-50">
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
              <h1 className="relative text-4xl font-extrabold tracking-tight text-warm-gray-800 sm:text-5xl lg:text-6xl">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                {/* Contact information */}
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-br from-indigo-50 to-indigo-100 sm:px-10 xl:p-12">
                  ...
                  <h3 className="text-lg font-medium font-semibold text-gray-600">
                    Contact information
                  </h3>
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-xl font-mono text-gray-600">
                      <div className="relative z-10">
                        <MailIcon className="h-8 z-10 relative text-gray-600" />
                        <span className="h-6 w-8 z-0 bg-yellow-100 absolute bottom-1 right-0 rounded-full transform rotate-3 rounded-lg"></span>
                      </div>
                      <span className="ml-3">contact@marsianog.com</span>
                    </dd>
                  </dl>
